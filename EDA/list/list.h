...
/** Get the position of the element of value = value_t. returns end() if not found */
iterator_t find(list_t *, value_t);

/** Get the value associated with the current position, which is really the value of the next node */
