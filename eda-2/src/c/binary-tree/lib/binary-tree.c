...
void b_tree_node_preorder(b_tree_node_t* node, b_tree_callback_t cb,
                          void* data) {
...
void b_tree_node_postorder(b_tree_node_t* node, b_tree_callback_t cb,
                           void* data) {
    if (node->left)
...
void b_tree_node_level(b_tree_node_t* node, size_t level, b_tree_callback_t cb,
                       void* data) {
    if (level == 0) {
        cb(node, data);
        return;
...
void b_tree_node_levelorder(b_tree_node_t* node, b_tree_callback_t cb,
                            void* data) {
    size_t height = b_tree_node_height(node), i;
...
size_t b_tree_node_search_and_replace(b_tree_node_t* node,
    ...
    b_tree_node_preorder(node, __b_tree_search_and_replace,
                         (void*)&search_data);
